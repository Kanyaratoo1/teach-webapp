...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        User::create(['first_name' => 'Teacher001', 'last_name' => '', 'username' => 'teacher001','usercode'=> 'T00000000002', 'email' => 'teacher01@localhost.com','password' => Hash::make($pwd), 'is_admin' => false]);
        foreach ($data as $u)
        {
            $user_id = "USER" . $i;
